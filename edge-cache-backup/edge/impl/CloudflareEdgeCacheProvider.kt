...
class CloudflareEdgeCacheProvider(
    ...
    private val freeTierLimit = 1000 // 1000 free purges per month
...
data class CloudflarePurgeResult(val id: String? = null, val purgedCount: Long? = null)

data class CloudflareError(val code: Int, val message: String)
