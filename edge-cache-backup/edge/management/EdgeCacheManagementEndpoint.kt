package com.yourcompany.cacheflow.edge.management
...
class EdgeCacheManagementEndpoint(private val edgeCacheManager: EdgeCacheManager) {
    ...
    @WriteOperation
    suspend fun purgeUrl(@Selector url: String): Map<String, Any> {
    ...
    @WriteOperation
    suspend fun purgeByTag(@Selector tag: String): Map<String, Any> {
    ...
    @DeleteOperation
    suspend fun resetMetrics(): Map<String, String> {
        // Note: In a real implementation, you might want to add a reset method to EdgeCacheMetrics
        return mapOf("message" to "Metrics reset not implemented in this version")
    }
}
