...
class EdgeCacheIntegrationServiceTest {
    ...
    fun `should purge single URL`() =
        runTest {
            ...
            whenever(edgeCacheManager.purgeUrl(url)).thenReturn(flowOf(expectedResult))
    ...
    @Test
    fun `should purge multiple URLs`() =
        runTest {
            // Given
            val urls =
                listOf(
            ...
            whenever(edgeCacheManager.purgeUrls(any())).thenReturn(expectedResults.asFlow())
    ...
    fun `should purge by tag`() =
        runTest {
            ...
            whenever(edgeCacheManager.purgeByTag(tag)).thenReturn(flowOf(expectedResult))
    ...
    fun `should purge all cache entries`() =
        runTest {
            ...
            whenever(edgeCacheManager.purgeAll()).thenReturn(flowOf(expectedResult))
    ...
    @Test
    fun `should purge cache key using base URL`() =
        runTest {
            // Given
            val baseUrl = "https://example.com"
            val cacheKey = "user-123"
            ...
            whenever(edgeCacheManager.purgeUrl("https://example.com/api/cache/user-123"))
    ...
    @Test
    fun `should purge multiple cache keys using base URL`() =
        runTest {
            // Given
            val baseUrl = "https://example.com"
            val cacheKeys = listOf("user-1", "user-2", "user-3")
    ...
    fun `should get health status`() =
        runTest {
            ...
            whenever(edgeCacheManager.getHealthStatus()).thenReturn(expectedHealthStatus)
    ...
    fun `should get statistics`() =
        runTest {
            ...
            whenever(edgeCacheManager.getAggregatedStatistics()).thenReturn(expectedStatistics)
    ...
    fun `should get rate limiter status`() {
        ...
        whenever(edgeCacheManager.getRateLimiterStatus()).thenReturn(expectedStatus)
    ...
    fun `should get circuit breaker status`() {
        ...
        whenever(edgeCacheManager.getCircuitBreakerStatus()).thenReturn(expectedStatus)
    ...
    fun `should get metrics`() {
        ...
        whenever(edgeCacheManager.getMetrics()).thenReturn(expectedMetrics)
