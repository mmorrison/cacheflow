...
class TestConfiguration {
    @Bean
    fun testService(): DependencyManagementIntegrationTest.TestService = DependencyManagementIntegrationTest.TestService()

    @Bean
    fun russianDollTestService(
        @Autowired fragmentCacheService: FragmentCacheService,
    ): RussianDollCachingIntegrationTest.RussianDollTestService =
